...
export default function Facilities() {
  ...
  function HandleSave() {
    if (ValidateFields()) {
      setValidated(true);
      fetch(
        "https://rahulrajrahu33.pythonanywhere.com/api/Admin/CreateFacilities/",
        {
          method: "POST",
          headers: {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://rahulrajrahu33.pythonanywhere.com/api/Admin/GetAllFacilities/",
      {
        method: "POST",
        headers: {
          Accept: "application/json",
    ...
    if (deletee.length != 0) {
      setDeleting(true);
      fetch(
        "https://rahulrajrahu33.pythonanywhere.com/api/Admin/DeleteFacilities/",
        {
          method: "POST",
          headers: {
            Accept: "application/json",
    ...
    if (edit.length != 0) {
      fetch(
        "https://rahulrajrahu33.pythonanywhere.com/api/Admin/GetFacilitiesById/",
        {
          method: "POST",
          headers: {
            Accept: "application/json",
